# Nancy.Plots.Tikz
## _Nancy extension to produce plots as TikZ code_

This package adds methods to produce plots as `TikZ` code.
...
The following lines will be needed in the LaTeX preamble:
...
This will replace the current methods in the `Unipi.Nancy.TikzPlot` namespace, which will be deprecated.
