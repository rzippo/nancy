...
public static class ToXUnitTestCasesExtensions
{
    ...
    /// Helper method that converts the list of tuples into a list of object[], as required by xUnit.
    /// </summary>
    public static IEnumerable<object[]> ToXUnitTestCases<T1, T2, T3, T4, T5, T6, T7, T8, T9>(this IEnumerable<ValueTuple<T1, T2, T3, T4, T5, T6, T7, ValueTuple<T8, T9>>> tuplesList)
    {
        foreach (var (t1, t2, t3, t4, t5, t6, t7, t8, t9) in tuplesList)
        {
