...
public class CurvePolimorphicNewtonsoftJson
{
    private readonly ITestOutputHelper output;

    public CurvePolimorphicNewtonsoftJson(ITestOutputHelper output)
    {
        this.output = output;
    }
    ...
    public void Coherency(Curve curve)
    {
        ...
        {
            Converters = new JsonConverter[] { new GenericCurveNewtonsoftJsonConverter() }
        };

        string serialization = JsonConvert.SerializeObject(curve, settings);
        output.WriteLine(serialization);
        var deserialized = JsonConvert.DeserializeObject<Curve>(serialization, settings)!;
    ...
    {
        var serialization = JsonConvert.SerializeObject(curve, new GenericCurveNewtonsoftJsonConverter(), new RationalNewtonsoftJsonConverter());
