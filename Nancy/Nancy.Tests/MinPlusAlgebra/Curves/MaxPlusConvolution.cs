    ...
    public static IEnumerable<(Curve f, Curve g, Curve expected)> PairsWithExpected()
    {
        var testcases = new List<(Curve f, Curve g, Curve expected)>
        {
            ...
            (
                ...
                g: Curve.FromJson(
                    "{\"type\":\"curve\",\"baseSequence\":{\"elements\":[{\"time\":0,\"value\":0,\"type\":\"point\"},{\"startTime\":0,\"endTime\":6,\"rightLimitAtStartTime\":0,\"slope\":0,\"type\":\"segment\"},{\"time\":6,\"value\":0,\"type\":\"point\"},{\"startTime\":6,\"endTime\":8,\"rightLimitAtStartTime\":0,\"slope\":0,\"type\":\"segment\"}]},\"periodStart\":6,\"periodLength\":2,\"periodHeight\":3}"
                ),
