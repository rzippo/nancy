...
public class Min
{
    ...
    public static IEnumerable<object[]> GetSetTestCases()
    {
        var testcases = new List<List<Curve>>
        {
            ...
            new List<Curve>
            {
                Curve.FromJson("{\"type\":\"curve\",\"baseSequence\":{\"elements\":[{\"time\":0,\"value\":0,\"type\":\"point\"},{\"startTime\":0,\"endTime\":2,\"rightLimitAtStartTime\":0,\"slope\":0,\"type\":\"segment\"},{\"time\":2,\"value\":0,\"type\":\"point\"},{\"startTime\":2,\"endTime\":3,\"rightLimitAtStartTime\":0,\"slope\":-1,\"type\":\"segment\"},{\"time\":3,\"value\":-1,\"type\":\"point\"},{\"startTime\":3,\"endTime\":7,\"rightLimitAtStartTime\":-1,\"slope\":0,\"type\":\"segment\"},{\"time\":7,\"value\":-1,\"type\":\"point\"},{\"startTime\":7,\"endTime\":9,\"rightLimitAtStartTime\":-1,\"slope\":0,\"type\":\"segment\"}]},\"pseudoPeriodStart\":7,\"pseudoPeriodLength\":2,\"pseudoPeriodHeight\":{\"num\":1,\"den\":0}}"),
                Curve.FromJson("{\"type\":\"curve\",\"baseSequence\":{\"elements\":[{\"time\":0,\"value\":{\"num\":1,\"den\":0},\"type\":\"point\"},{\"startTime\":0,\"endTime\":6,\"rightLimitAtStartTime\":{\"num\":1,\"den\":0},\"slope\":{\"num\":1,\"den\":0},\"type\":\"segment\"},{\"time\":6,\"value\":0,\"type\":\"point\"},{\"startTime\":6,\"endTime\":8,\"rightLimitAtStartTime\":0,\"slope\":0,\"type\":\"segment\"}]},\"pseudoPeriodStart\":6,\"pseudoPeriodLength\":2,\"pseudoPeriodHeight\":-3}"),
                Curve.FromJson("{\"type\":\"curve\",\"baseSequence\":{\"elements\":[{\"time\":0,\"value\":{\"num\":1,\"den\":0},\"type\":\"point\"},{\"startTime\":0,\"endTime\":3,\"rightLimitAtStartTime\":{\"num\":1,\"den\":0},\"slope\":{\"num\":1,\"den\":0},\"type\":\"segment\"},{\"time\":3,\"value\":-2,\"type\":\"point\"},{\"startTime\":3,\"endTime\":5,\"rightLimitAtStartTime\":-2,\"slope\":0,\"type\":\"segment\"}]},\"pseudoPeriodStart\":3,\"pseudoPeriodLength\":2,\"pseudoPeriodHeight\":-1}"),
                Curve.FromJson("{\"type\":\"curve\",\"baseSequence\":{\"elements\":[{\"time\":0,\"value\":{\"num\":1,\"den\":0},\"type\":\"point\"},{\"startTime\":0,\"endTime\":9,\"rightLimitAtStartTime\":{\"num\":1,\"den\":0},\"slope\":{\"num\":1,\"den\":0},\"type\":\"segment\"},{\"time\":9,\"value\":-2,\"type\":\"point\"},{\"startTime\":9,\"endTime\":11,\"rightLimitAtStartTime\":-2,\"slope\":0,\"type\":\"segment\"}]},\"pseudoPeriodStart\":9,\"pseudoPeriodLength\":2,\"pseudoPeriodHeight\":-3}")
            },
            // no tt term
            new List<Curve>
            {
    ...
    {
        // a is below b over both base sequences, but the two have different periods: past those,
        // they are at different phases, and b undercuts a once per least common multiple.
        // Deciding the period of the result from that comparison left it above b from 10.5 on.
        var a = new Curve(
