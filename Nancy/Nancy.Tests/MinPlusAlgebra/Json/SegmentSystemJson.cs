...
public class SegmentSystemJson
{
    private readonly ITestOutputHelper output;

    public SegmentSystemJson(ITestOutputHelper output)
    {
        this.output = output;
    }
    ...
    {
        string serialization = JsonSerializer.Serialize(segment);
        output.WriteLine(serialization);
        Segment deserialized = JsonSerializer.Deserialize<Segment>(serialization)!;
    ...
    {
        var deserialized = JsonSerializer.Deserialize<Segment>(serialization)!;
