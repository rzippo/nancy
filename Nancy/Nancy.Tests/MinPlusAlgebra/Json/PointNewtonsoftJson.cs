...
public class PointNewtonsoftJson
{
    private readonly ITestOutputHelper output;

    public PointNewtonsoftJson(ITestOutputHelper output)
    {
        this.output = output;
    }
    ...
    {
        var deserialized = JsonConvert.DeserializeObject<Point>(serialization, new RationalNewtonsoftJsonConverter())!;
