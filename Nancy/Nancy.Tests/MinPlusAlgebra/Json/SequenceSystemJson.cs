...
public class SequenceSystemJson
{
    private readonly ITestOutputHelper output;

    public SequenceSystemJson(ITestOutputHelper output)
    {
        this.output = output;
    }
    ...
    {
        string serialization = JsonSerializer.Serialize(sequence);
        output.WriteLine(serialization);
        Sequence deserialized = JsonSerializer.Deserialize<Sequence>(serialization)!;
    ...
    {
        var deserialized = JsonSerializer.Deserialize<Sequence>(serialization)!;
